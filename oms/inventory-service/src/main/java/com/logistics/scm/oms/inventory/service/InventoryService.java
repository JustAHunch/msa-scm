...
public interface InventoryService {
     ...
     * @return 재고 응답 DTO
     */
    InventoryResponseDTO reserveStock(ReserveStockRequestDTO request);
     ...
     * @return 재고 응답 DTO
     */
    InventoryResponseDTO releaseStock(ReleaseStockRequestDTO request);
     ...
     * @return 재고 응답 DTO
     */
    InventoryResponseDTO getInventory(UUID warehouseId, String productCode);
     ...
     * @return 재고 목록
     */
    List<InventoryResponseDTO> getInventoriesByProductCode(String productCode);
     ...
     * @return 재고 목록
     */
    List<InventoryResponseDTO> getInventoriesByWarehouse(UUID warehouseId);
     ...
     * @return 재고 응답 DTO
     */
    InventoryResponseDTO createOrUpdateInventory(UUID warehouseId, String productCode, 
